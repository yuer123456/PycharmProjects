...
class TestZuoYe1:
    def setup(self):
        ...
        # caps["chromedriverExecutableDir"]="/Users/lxy07/Desktop/chromedriver/all"
        caps["chromedriverExecutable"] = "/Users/lxy07/Desktop/chromedriver/all/chromedriver_2.20"
    ...
    def test_uiselector(self): # 使用uiautomator selector 定位
        scroll_to_element = (
