...
from devices.deviceapi.baseapi import BaseApi
...
class Api(BaseApi):
    ...
    def __init__(self):
        ...
        self.data = self.api_load("../deviceapi/device.api.yaml")


    def login(self):
        return self.api_send(self.data['login'])
    ...
    def xinzeng(self):
        ...
        r = self.s.post("http://l-cuedocker1.dev.cn2.corp.agrant.cn:32097/api/instore/createV2",
                        ...
                        json={"inStoreType": 0, "deviceTypeId": "camera", "subDeviceTypeId": "camera_ip",
                              "modelId": "CB20-S02", "purchaseRequestNo": "214124", "purchaseNo": "1234124",
                              "cashNo": "",
                              "companyId": "nanjinganyuji", "repoId": "beijing", "deliveryMethod": 1, "trackingNo": "",
                              "consignee": "", "referredPerson": "122112", "referredPersonContact": "121212",
                              "comment": "",
                              "address": "",
                              "deviceList": [
                                  {"macId": self.macid, "deviceCode": "1243124124", "subModelId": "4mm",
                                   "checkStatus": 1}]})
        print(self.macid)
        print(r.json())
        return r.json()
